...
const createStudent = (student, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const academicSemester =
      yield academicSemster_model_1.AcademicSemester.findById(
    ...
    try {
      ...
      if (!newStudent.length) {
        throw new ApiError_1.default(
          ...
          'Felid to create student',
        )
      }
      user.student =
        (_a = newStudent[0]) === null || _a === void 0 ? void 0 : _a._id
      const newUser = yield user_modal_1.User.create([user], { session })
      if (!newUser.length) {
        throw new ApiError_1.default(
          http_status_1.default.BAD_REQUEST,
          'Felid to create User',
        )
      }
    ...
    if (userAllData) {
      userAllData = yield user_modal_1.User.findOne({
        id: userAllData.id,
      }).populate({
        path: 'student',
        populate: [
