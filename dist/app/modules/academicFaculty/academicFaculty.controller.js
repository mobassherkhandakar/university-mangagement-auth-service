...
const createFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicFaculty_service_1.academicFacultyService.createFaculty(academicFaculty);
...
const getAllFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paginationOption = (0, pick_1.default)(req.query, pagination_1.paginationSortFiled);
    const result = yield academicFaculty_service_1.academicFacultyService.getAllFaculty(filters, paginationOption);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
